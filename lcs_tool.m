...
if get(hObject,'Value')
    ...
    set(findobj(handles.strainlineAxes,'Tag','strainlineFiltered'),...
        'Visible','on')
else
...
options = odeset('AbsTol',get(handles.absTol,'UserData'),'RelTol',...
    get(handles.relTol,'UserData'),'OutputFcn',...
    @(t,y,flag)ode_output_fcn(t,y,flag,handles,frameDelay));
