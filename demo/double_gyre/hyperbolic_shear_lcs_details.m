...
closedLambdaLine = poincare_closed_orbit_range(domain,resolution,cgEigenvector,cgEigenvalue,lambda,poincareSection,'forceEtaComplexNaN',forceEtaComplexNaN,'lambdaLineOdeSolverOptions',lambdaLineOdeSolverOptions,'showPoincareGraph',showPoincareGraph);
...
% FIXME code below does nothing since closedLambdaLine contains only
% outermost closed lambda line
