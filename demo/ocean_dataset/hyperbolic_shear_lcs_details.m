...
hNo = arrayfun(@(i)text(poincareSection(i).endPosition(1,1)-0.3,poincareSection(i).endPosition(1,2),num2str(i),'color','k','FontSize',16, 'fontname','lucida'),1:nPoincareSection);
drawnow
...
for lambda = lambdaRange
    ...
    for i = 1:nPoincareSection
        ...
        if max(orbitArea) > closedLambdaLineArea(i)
            ...
            % Keep lambda values associated to outermost closed orbit of
