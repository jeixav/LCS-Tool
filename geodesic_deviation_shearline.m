...
shearline.geodesicDeviationPos = cellfun(@(position)...
    geodesic_deviation_individual(position,l1Interpolant,...
    l2Interpolant,dl1Interpolant,alphaInterpolant,betaInterpolant,...
    dAlphaInterpolant,etaPosInterpolant,xi1Interpolant,xi2Interpolant,...
    dxi1Interpolant,dxi2Interpolant,flow,posOrNeg,devMode),...
    shearline.positionPos,'uniformOutput',false);

posOrNeg = 'neg';
shearline.geodesicDeviationNeg = cellfun(@(position)...
    geodesic_deviation_individual(position,l1Interpolant,...
    l2Interpolant,dl1Interpolant,alphaInterpolant,betaInterpolant,...
    dAlphaInterpolant,etaNegInterpolant,xi1Interpolant,xi2Interpolant,...
    dxi1Interpolant,dxi2Interpolant,flow,posOrNeg,devMode),...
    shearline.positionNeg,'uniformOutput',false);
